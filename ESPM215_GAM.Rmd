...
- Exercise: try to visually choose optimal lambda parameter (Kane)
...
ggplot(ISIT16) + 
  geom_point(aes(Depth1000, Sources)) + 
  geom_line(aes(Depth1000, fitted(fit1)), color = 'red')
```

- Create lambda vs. GCV graph to choose optimal lambda (Kane)
- Compare with automatic GCV from model fit (Kane)
